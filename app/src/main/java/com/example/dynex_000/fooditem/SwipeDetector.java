...
public class SwipeDetector implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link SwipeDetector} to inform its client
     ...
     */
    public SwipeDetector(ListView listView, OnSwipeCallback callback) {
     ...
     * @see #SwipeDetector(ListView, OnSwipeCallback, boolean, boolean)
     */
    public SwipeDetector(ListView listView, OnSwipeCallback callback, boolean dismissLeft, boolean dismissRight) {
     ...
     * {@link SwipeDetector} is paused during list view scrolling.</p>
     *
     * @see {@link SwipeDetector}
     */
