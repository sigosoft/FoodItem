...
public class About extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HyperLink2 = (TextView)findViewById(R.id.textView0);

        Text = Html.fromHtml("" +
                "<a href='http://www.dynexoit.com//'>www.dynexoit.com</a>");

        HyperLink.setMovementMethod(LinkMovementMethod.getInstance());
        HyperLink.setText(Text);

        Text2 = Html.fromHtml("" +
                "<a href='https://web.facebook.com/Dynexo-I-T-Solutions-683538935068877'>Like us on facebook </a>");
