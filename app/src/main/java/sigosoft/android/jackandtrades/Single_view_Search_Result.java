...
//ic_arroesa:image of cart
        ic_arrowsa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {


                Intent i = new Intent(Single_view_Search_Result.this, CartActivity.class);
                startActivity(i);

            }
        });
//ic_arrows:image of backbutton
...
//
//DynexoPrefManager:shared preference page
    ...
    public class LoadDataph extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (responsefromserver == null) {
                ...
                Intent k = new Intent(Single_view_Search_Result.this, CartActivity.class);
                startActivity(k);
                finish();
