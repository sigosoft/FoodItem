...
public class listViewAdapter3 extends BaseAdapter {
    ...
    public listViewAdapter3(Context context, ArrayList<BeanClassForListView3> beanClassArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        BeanClassForListView3 beanClass = (BeanClassForListView3) getItem(position);
